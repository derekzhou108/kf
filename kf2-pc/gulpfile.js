...
gulp.task('connect', () => {
    connect.server({
        ...
        middleware(connect, opt){
            return [
                proxy('/kf',  {
                    // target: 'http://115.159.189.146:8021',
                ...
                proxy('/sdk-user',  {
                    // target: 'http://115.159.189.146:8021',
                    target: 'http://10.10.40.33:8440',
                    changeOrigin:true
                }),
                // proxy('/upload/img',{
                //     target: 'http://115.159.189.146:8066',
                //     changeOrigin:true
                // })
            ]
        }
...
gulp.task('moveIndex', () => {
    return gulp.src('dist/index.html')
        ...
        .pipe(gulp.dest('../../../modules/yzsmr/views/site'));
});

gulp.task('moveFile', () => {
   return  gulp.src('dist/*.html')
        .pipe(rename({extname: '.php'}))
        .pipe(gulp.dest('../../views/kf2pc'));
});
